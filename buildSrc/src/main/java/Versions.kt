object Versions {
    ...
    const val ktLintSnapshotVersion = "0.50.0"
    const val detektVersion = "1.23.1"
    const val benManesVersion = "0.48.0"
    ...
    const val liveDataKtxVersion = "2.6.2"
    ...
    const val androidxArchCoreVersion = "2.2.0"
